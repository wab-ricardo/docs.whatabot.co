...
This Privacy Policy is designed to help you understand what information we collect at Scadco \(dba WhatABot\), how we use it, and what choices you have.
...
WhatABot collects information, including Personal Data, for the following purposes:
...
In the course of providing the Service, WhatABot may receive, access, analyze, process and maintain Personal Data on behalf of our Customers.
...
WhatABot collects the following information from you through our Website \([https://whatabot.co](https://whatabot.co)\), social media, and other channels for the following purposes:
...
2. **Changes to our Business Structure.** WhatABot may share or disclose data if we engage in a merger, acquisition, bankruptcy, dissolution, reorganization, sale of some or all of WhatABot’s assets, financing, acquisition of all or a portion of our business, a similar transaction or proceeding, or steps in contemplation of such activities \(e.g. due diligence\).
3. **Compliance with Laws.** WhatABot and other Service Providers may share or disclose Personal Data to comply with legal or regulatory requirements and to respond to lawful requests, court orders and legal process.
4. **Enforcing Our Rights, Preventing Fraud, and Safety.** WhatABot may share or disclose data to protect and defend the rights, property, or safety of us or third parties, including enforcing contracts or policies, or in connection with investigation and preventing fraud.
...
WhatABot takes security seriously. We take various steps to protect information you provide to us from loss, misuse, and unauthorized access or disclosure. These steps take into account the sensitivity of the information we collect, process and store, and the current state of technology.

## 7. Cookie Policy

WhatABot may use cookies and similar technologies like single-pixel gifs and web beacons, to record log data. We use both session-based and persistent cookies.
...
WhatABot sets and accesses our own cookies on the domains operated by WhatABot and its affiliates. In addition, we use third parties like Google Analytics for website analytics. You may opt-out of third party cookies from Google Analytics on its website. We do not currently recognize or respond to browser-initiated Do Not Track signals as there is no consistent industry standard for compliance.
